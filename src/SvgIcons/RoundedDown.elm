module SvgIcons.RoundedDown exposing (..)
...
roundedDown : List (Html.Attribute msg) -> Element msg
roundedDown moreAttributes =
    html
        (svg
            (List.concat
                [ moreAttributes
            ...
            , Svg.title []
                [ text "rounded-down" ]
            , Svg.glyph
                [ SvgAttr.glyphName "rounded-down"
                , SvgAttr.unicode "\u{EA99}"
